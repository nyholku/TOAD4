...
#define motor_x 0
#define motor_y 0 (motor_x + motor_size)
#define motor_z 0 (motor_x + 2 * motor_size)
#define motor_4 0 (motor_x + motor_size)
...
motorproc macro motor,step_out_port,step_out_bit,dir_out_bit,dir_out_port
;
	local label1
	local label2
	local label3
